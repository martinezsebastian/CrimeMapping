...
**Figure 2** shows the Community Districts (on which the Census Data is based) with the centers of the districts and the centers of the . 
```{r, echo=FALSE}
...
## WE MULTIPLY BY 2/3* TO CONTROL FOR THE FACT THAT REDUCING THE AREA RADIUS OF THE CIRCLE BY 50% DOES NOT 
## A REDUCTION IN 50% OF THE AREA 
## THIS IS A ROUGH ESTIMATION
## CLOSE REPRESENTS WHETHER A CRIME IS COMMITTED CLOSE OR FAR
...
#"SEX OFFENSE"
##################################
## CRIMES ARE GROUPED INTO TWO DIFFERENT GROUPS. MORE GROUPS WILL BE ADDED. 
##################################
...
kable(as.matrix(table1), digits = 2, caption = "Aggregate Crime Statistics (Number of crimes committed in every District accross all types") 
kable(as.matrix(table2), digits = 2, caption = "Aggregate Crime Statistics (Relative Distance to Policy Station and to District Center accross all crime types") 
```
As you can observe from the previous table, the information contained in the last table, the distances for the location of the crimes changes with respect of the center point (unsurprising, given the fact that these two are not located in the same place whithin the district). However, it is interesting to notice which kinds of crimes tend to occur farther away from the center of the district, as well as which ones tend to occur farther away from where the stations is located.
...
hist(reldistindsta, freq=FALSE, main ="Relative Distance for individual Police Districts")
...
## Creating Dummy variable for Close and Far 

dividing max. distance by 2 => assigning close and far dummy var. 

2/3 of the distance => 


## Grouping crimes in categories 
