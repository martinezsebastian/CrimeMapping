...
This document presents our data collection and transformation efforts, including the calculation of distances between crime locations and the center of police districts and community districts. We gather data on crime, district borders and socioeconomic inidcators from the City of Chicago Data Portal and merge them into one dataset. Using R, we calculate the distance between crime locations and district centers and add this information to the data frame. We also conduct descriptive statistics on the data, show first results concerning the relativie distance of different crimes from the center of police districts and include maps showing our calculation of district centers as well as crime locations. 
...
## kable function DOES NOT WORK AT THE MOMENT!
...
Based on google maps, Figure 3 presents the delineation of police districts across Chicago. 
```{r, echo=FALSE}
