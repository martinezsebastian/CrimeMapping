...
1. The absolute distance of each crime to the district's police station

2. The relative distance based on the crime in each district that is farthest away from the district's police station. 
...
# Relative Distance
## To determine the relative distances (crime farthest away=100)
district_list <- list()
